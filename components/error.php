...
<head>
	...
	<meta name="description" content="<?= $MESSAGE['Page.Error.Description'] ?>">
	<meta property="og:url" content="<?= "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>">
	<meta property="og:title" content="<?= $MESSAGE['Page.Error.Title'] ?>">
	<meta property="og:type" content="website">
	<meta property="og:image" content="http://skr.ac.th/link/loykrathong/assets/images/share.png">
	<meta property="og:description" content="<?= $MESSAGE['Page.Error.Description'] ?>">
	<title><?= $MESSAGE['Page.Error.Title'] ?></title>
	<link rel="icon"
		...
		<main>
			...
			<div class="SelectName modal hidden">
				<div class="content">
					...
					<div class="twocol">
						<div class="kra3">
							<input id="nameMessage" placeholder="<?= $MESSAGE['Text.Home.SelectName_placeholder'] ?>" type="text">
